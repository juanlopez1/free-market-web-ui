...
const ArrowUp: FC<ArrowUpRightProps> = ({ className, color = '#999' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className={className} viewBox="0 0 330 330" fill="none">
        <path
            fill={color}
